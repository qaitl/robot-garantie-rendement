...
Scénario: Exécuter SMJOB Mode 2
    [Documentation]    Le robot lance le SMJOB (UASCVRD) avec le paramètre en mode 2 (INPUT(FINPUT) = FICH1)
    # Evidemment, il faudrait réutiliser le job 1
    ...
    Et je remplis le champs IMS suivant "CODE MODE" avec "2{RETURN}"
